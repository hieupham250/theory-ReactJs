...
// 1. tính đóng gói (encapsulation)
class Person {
    public name1: string // mặt định phạm vi truy cập là public
    private age1: number // trong trường hợp phạm vi là private để truy cập được thì thông qua phương thức: lấy ra: get, set
